...
void PrivatepayConfig::clickBasic()
{
    ...
    QMessageBox::information(this, tr("PrivatePay Configuration"),
        tr(
            "PrivatePay was successfully set to basic (%1 and 2 rounds). You can change this at any time by opening Waggox's configuration screen."
        ).arg(strAmount)
    );
...
void PrivatepayConfig::clickHigh()
{
    ...
    QMessageBox::information(this, tr("PrivatePay Configuration"),
        tr(
            "PrivatePay was successfully set to high (%1 and 8 rounds). You can change this at any time by opening Waggox's configuration screen."
        ).arg(strAmount)
    );
...
void PrivatepayConfig::clickMax()
{
    ...
    QMessageBox::information(this, tr("PrivatePay Configuration"),
        tr(
            "PrivatePay was successfully set to maximum (%1 and 16 rounds). You can change this at any time by opening Waggox's configuration screen."
        ).arg(strAmount)
    );
