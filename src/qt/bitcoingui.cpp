    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Waggox Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Waggox Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Waggox Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Waggox Core help message to get a list with possible Waggox Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Waggox Core client") + " " + networkStyle->getTitleAddText();
