...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, const CCoinControl *coinControl)
{
...

    {
        ...
        if(recipients[0].fUseInstaPay && total > sporkManager.GetSporkValue(SPORK_5_INSTAPAY_MAX_VALUE)*COIN){
            Q_EMIT message(tr("Send Coins"), tr("InstaPay doesn't support sending values that high yet. Transactions are currently limited to %1 WAGGOX.").arg(sporkManager.GetSporkValue(SPORK_5_INSTAPAY_MAX_VALUE)),
