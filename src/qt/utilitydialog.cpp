    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Waggox Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Waggox Core"));
...
For more info see <a href=\"https://waggoxpay.atlassian.net/wiki/display/DOC/PrivatePay\">https://waggoxpay.atlassian.net/wiki/display/DOC/PrivatePay</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Waggox Core is shutting down...") + "<br /><br />" +
