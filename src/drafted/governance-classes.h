 ...
 *
 *   // network
 *   CWaggoxNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.waggox.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CWaggoxNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: WaggoxNetwork
// //   -- signature requirements : Key1(User)
// class CWaggoxNetworkVariable : public CGovernanceObject
// {
// private:
