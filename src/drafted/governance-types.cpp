...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "WaggoxNetwork") type = WaggoxNetwork;
    if(strType == "WaggoxNetworkVariable") type = WaggoxNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == WaggoxNetwork) s = "WaggoxNetwork";
    if(type == WaggoxNetworkVariable) s = "WaggoxNetworkVariable";
