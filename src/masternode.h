...
//
// The Masternode Class. For managing the PrivatePay process. It contains the input of the 100000 WAGGOX, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 100000 WAGGOX - checking if valid masternode)
