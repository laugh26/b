...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    CService addr3 = CService("250.3.2.2", 8282);
    CService addr4 = CService("250.3.3.3", 8282);
    ...
    BOOST_CHECK(addrman.Select().ToString() == "250.3.2.2:8282");
    BOOST_CHECK(addrman.Select().ToString() == "250.3.3.3:8282");
...
BOOST_AUTO_TEST_CASE(addrman_find)
{
    ...
    CAddress addr2 = CAddress(CService("250.1.2.1", 8282), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(addrman_getaddr)
{
    ...
    CAddress addr2 = CAddress(CService("250.251.2.2", 8282), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(caddrinfo_get_tried_bucket)
{
    ...
    CAddress addr2 = CAddress(CService("250.1.1.1", 8282), NODE_NONE);
