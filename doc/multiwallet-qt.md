...
Only requiring some minor changes is waggox.cpp.
...
Changes to waggox.cpp
----------------------
waggox.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
