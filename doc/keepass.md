...
Sample initialization flow from _waggox-qt_ console (this needs to be done only once to set up the association):
 ...
 - Keepass pops up and asks for an association id, fill that in, for example, "_mywaggoxwallet_"
 - You should get a response like this "_Association successful. Id: mywaggoxwalletwaggox - Key: AgQkcs6cI7v9tlSYKjG/+s8wJrGALHl3jLosJpPLzUE=_"
 - Edit _waggox.conf_ and fill in these values
```
keepass=1
keepasskey=AgQkcs6cI7v9tlSYKjG/+s8wJrGALHl3jLosJpPLzUE=
keepassid=mywaggoxwallet
...
Extended guide with screenshots is also available: https://waggoxtalk.org/threads/keepass-integration.3620/
