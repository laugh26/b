...
in the Waggox Core repository under 'Fetch and build inputs' to install sources which require
...
BTCPATH=/some/root/path/waggox.git
SIGPATH=/some/root/path/waggox-detached-sigs.git
