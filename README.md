Waggox Core staging tree 1.0.0
===============================
...
Waggox is an experimental new digital currency that enables anonymous, instant
...
the Dash Core software, see https://waggox.one.
